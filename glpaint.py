...
menubar.add_cascade(label="fichier",menu=submenu)
menubar.add_cascade(label="supprimer",menu=submenu)
menubar.add_cascade(label="edition",menu=submenu)
...
def display_palette():
    ...
    id=canvas.create_rectangle((10,35,30,60),fill="gray")
